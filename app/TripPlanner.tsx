...
const UPDATED_HOURLY_PLANS: HourlyPlan[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { time: "14:00–15:00", title: "锦市场熟食小吃", detail: "只挑能问清成分的热食；你的鱼介、鲑鱼、柴鱼片与出汁风险要逐项确认。", area: "锦市场", placeId: "nishiki", price: "¥3,000–6,000 / 两人", tag: "吃" },
      { time: "15:00–16:00", title: "寺町 · 新京极", detail: "雨天也能逛的商店街；买伴手礼但不要提前把行李塞满。", area: "河原町", placeId: "teramachi", tag: "购物" },
      { time: "16:00–17:00", title: "八坂神社与花见小路", detail: "按顺序从八坂进入祇园；不拦人、不追拍艺伎，遵守当地禁止拍摄提示。", area: "祇园", placeId: "yasaka", tag: "文化" },
      { time: "17:00–18:30", title: "清水寺 / 二年坂三年坂（体力够再加）", detail: "坡道多，雨天穿防滑鞋；时间或体力不够就留在花见小路，不为‘全都去’赶路。", area: "东山", placeId: "kiyomizu", tag: "古迹" },
      { time: "18:30–20:00", title: "先斗町熟食晚餐", detail: "选择烧肉、乌冬、定食等熟食；女友海鲜单独安排，你继续确认出汁和酱汁。", area: "四条河原町", placeId: "pontocho", price: "¥5,000–10,000 / 两人", tag: "吃" },
      { time: "20:00–21:30", title: "鴨川边散步", detail: "只走一小段就回酒店；把京都夜色当作放松，不再加远处景点。", area: "鴨川", tag: "夜景" },
...
const RESEARCH_TIPS = [
  ...
  },
  {
    ...
    decision: "直接采用“只换一次酒店”和 D4 东京→大阪的松弛边界；把银座移到 D3、保留 D1 浅草 + 上野，并把早班机降为需要机场酒店的例外，不破坏你们的晚起作息。",
    usedIn: "D1、D3、D4、D5",
